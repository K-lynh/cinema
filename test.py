...
GENRE_ALIASES: dict[str, list[str]] = {
    "hành động":             ["hành động", "action", "võ thuật", "chiến đấu", "đánh nhau"],
    "tình cảm":              ["tình cảm", "lãng mạn", "romantic", "tình yêu", "yêu đương"],
    "hài":                   ["hài", "comedy", "hài hước", "vui nhộn", "buồn cười"],
    "kinh dị":               ["kinh dị", "horror", "ma quỷ", "rùng rợn", "đáng sợ"],
    "hoạt hình":             ["hoạt hình", "cartoon", "animation"],
    "tâm lý":                ["tâm lý", "drama", "cảm xúc", "sâu sắc"],
    "khoa học viễn tưởng":   ["khoa học viễn tưởng", "sci-fi", "viễn tưởng", "ngoài hành tinh"],
    "cổ trang":              ["cổ trang", "lịch sử", "ngày xưa", "thời xưa"],
    "gia đình":              ["gia đình", "family", "bố mẹ", "con cái"],
    "tội phạm":              ["tội phạm", "crime", "trinh thám", "điều tra", "xã hội đen"],
    "lgbt":                  ["lgbt", "đồng tính", "gay", "les"],
    "xã hội":                ["xã hội", "cuộc sống", "đời thường"],
}

ROLE_ALIASES: dict[str, list[str]] = {
    "bố":        ["bố", "cha", "ba", "phụ thân", "người cha", "người bố", "làm bố", "vai bố", "vai cha"],
    "mẹ":        ["mẹ", "má", "mẫu thân", "người mẹ", "làm mẹ", "vai mẹ"],
    "con":       ["con", "con trai", "con gái", "đứa con"],
    "vợ":        ["vợ", "bà xã", "người vợ"],
    "chồng":     ["chồng", "ông xã", "người chồng"],
    "phản diện": ["phản diện", "kẻ xấu", "ác nhân", "villain"],
    "thám tử":   ["thám tử", "điều tra viên"],
    "cảnh sát":  ["cảnh sát", "công an", "sĩ quan"],
    "bác sĩ":    ["bác sĩ", "y sĩ", "thầy thuốc"],
    "giang hồ":  ["tướng cướp", "đại ca", "giang hồ", "xã hội đen"],
}

EMOTION_ALIASES: dict[str, list[str]] = {
    "cảm động": ["cảm động", "xúc động", "nước mắt", "khóc", "buồn", "da diết", "nuối tiếc"],
    "vui":      ["vui", "hài hước", "cười", "thoải mái", "vui nhộn"],
    "hồi hộp":  ["hồi hộp", "căng thẳng", "kịch tính", "gay cấn"],
    "sợ hãi":   ["sợ", "rùng mình", "đáng sợ", "ám ảnh"],
    "lãng mạn": ["lãng mạn", "ngọt ngào", "yêu nhau"],
}
